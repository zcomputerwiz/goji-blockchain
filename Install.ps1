...
{
    Write-Output "Goji requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Goji blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Keybase in the #support chat channel:"
Write-Output "https://keybase.io/team/goji_network.public"
Write-Output ""
Write-Output "Try the Quick Start Guide to running goji-blockchain:"
Write-Output "https://github.com/Goji-Network/goji-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'goji init' to begin."
