...
def validate_fee(ctx, param, value):
    try:
        ...
        raise click.BadParameter("Fee must be decimal dotted value in XGJ (e.g. 0.00005)")
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in XGJ. Fee is used TWICE: once to create the singleton, once for init.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in XGJ. Fee is used TWICE: once to leave pool, once to join.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "--fee",
    help="Fee Per Transaction, in Mojis. Fee is used TWICE: once to leave pool, once to join.",
    type=int,
    callback=validate_fee,
    default=0,
)
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in XGJ. Fee is charged TWICE.",
    type=str,
    default="0",
    show_default=True,
    required=True,
...
@click.option(
    "--fee",
    help="Transaction Fee, in Mojis. Fee is charged twice if already in a pool.",
    type=int,
    callback=validate_fee,
    default=0,
)
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in XGJ.",
    type=str,
    default="0",
    show_default=True,
    required=True,
