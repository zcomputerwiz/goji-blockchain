...
class KeyringWrapper:
    ...
    def confirm_migration(self) -> bool:
        ...
        if master_passphrase == DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE:
            ...
            print(
                "Would you like to set a master passphrase now? Use 'replaceme passphrase set' to change the passphrase.\n"
            )
            ...
            if response:
                ...
                print(
                    "Will skip setting a master passphrase. Use 'replaceme passphrase set' to set the master passphrase.\n"
                )
        else:
            import colorama
