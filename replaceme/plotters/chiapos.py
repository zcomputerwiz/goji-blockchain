"""
NOTE: This contains duplicate code from `goji.cmds.plots`.
After `goji plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Goji Proof of Space", "version": chiapos_version, "installed": True}
