...
from goji.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from goji.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from goji.pools.pool_puzzles import (
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `goji singleton` that is
