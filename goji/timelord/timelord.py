...
from goji.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from goji.timelord.iters_from_block import iters_from_block
from goji.timelord.timelord_state import LastState
from goji.timelord.types import Chain, IterationType, StateType
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[GojiServer] = None
