...
from goji.plotting.create_plots import resolve_plot_keys
from goji.plotters.plotters_util import run_plotter, run_command
    ...
    if is_madmax_supported():
        ...
        run_command(
            [
                "git",
                "clone",
                "https://github.com/Goji-Network/goji-plotter-madmax.git",
                MADMAX_PLOTTER_DIR,
            ],
...
def plot_madmax(args, goji_root_path: Path, plotters_root_path: Path):
