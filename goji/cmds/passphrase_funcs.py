...
from goji.daemon.client import acquire_connection_to_daemon
from goji.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
from goji.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Goji processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("GOJI_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'goji passphrase set' or 'goji passphrase remove' to update or remove your passphrase")
        sys.exit(1)
