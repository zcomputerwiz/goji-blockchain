...
from goji.server.start_full_node import SERVICE_NAME
...
from goji.consensus.pot_iterations import calculate_iterations_quality
from goji.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
