...
from goji.wallet.puzzles.p2_conditions import puzzle_for_conditions
from goji.wallet.puzzles import singleton_top_layer
from goji.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - goji.pools.pool_puzzles.py
    - goji.wallet.puzzles.pool_member_innerpuz.clvm
    - goji.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
