...
from goji.pools.pool_config import PoolWalletConfig
from goji.util.config import load_config, save_config, create_default_goji_config
...
def test_pool_config():
    ...
    create_default_goji_config(test_root, ["config.yaml"])
