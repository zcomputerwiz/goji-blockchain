...
from goji.util.keychain import Keychain, default_keychain_service, default_keychain_user, get_private_key_user
from goji.util.keyring_wrapper import KeyringWrapper
...
class TempKeyring:
    def __init__(
        ...
        *,
        ...
        service: str = "testing-goji-1.8.0",
        populate: bool = False,
    ...
    def _patch_and_create_keychain(
        ...
        *,
        ...
        mock_supports_keyring_passphrase_patch = patch("goji.util.keychain.supports_keyring_passphrase")
        ...
        mock_supports_os_passphrase_storage_patch = patch("goji.util.keychain.supports_os_passphrase_storage")
