...
from goji.consensus.block_rewards import calculate_pool_reward, calculate_base_farmer_reward
from goji.protocols import wallet_protocol, full_node_protocol
from goji.protocols.full_node_protocol import RespondTransaction
from goji.protocols.protocol_message_types import ProtocolMessageTypes
from goji.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
...
class TestSimpleSyncProtocol:
    ...
    async def test_subscribe_for_ph(self, wallet_node_simulator):
        ...
        from goji.wallet.puzzles.singleton_top_layer import SINGLETON_LAUNCHER_HASH
