...
from goji.cmds.init_funcs import create_all_ssl, create_default_goji_config
from goji.daemon.keychain_proxy import connect_to_keychain_and_validate, wrap_local_keychain
from goji.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from goji.util.errors import Err
from goji.full_node.generator import setup_generator_args
from goji.full_node.mempool_check_conditions import GENERATOR_MOD
from goji.plotting.create_plots import create_plots, PlotKeys
...
from goji.consensus.coinbase import create_puzzlehash_for_pk, create_farmer_coin, create_pool_coin
from goji.consensus.condition_costs import ConditionCost
from goji.consensus.constants import ConsensusConstants
from goji.consensus.default_constants import DEFAULT_CONSTANTS
from goji.consensus.deficit import calculate_deficit
...
from goji.consensus.vdf_info_computation import get_signage_point_vdf_info
from goji.full_node.signage_point import SignagePoint
from goji.plotting.util import PlotsRefreshParameter, PlotRefreshResult, PlotRefreshEvents, parse_plot_info
...
from goji.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
from goji.types.blockchain_format.pool_target import PoolTarget
from goji.types.blockchain_format.program import INFINITE_COST
...
from goji.types.blockchain_format.slots import (
...
from goji.util.config import load_config, save_config
from goji.util.hash import std_hash
from goji.util.ints import uint8, uint16, uint32, uint64, uint128
from goji.util.keychain import Keychain, bytes_to_mnemonic
from goji.util.merkle_set import MerkleSet
from goji.util.prev_transaction_block import get_prev_transaction_block
from goji.util.path import mkdir
from goji.util.vdf_prover import get_vdf_info_and_proof
from tests.time_out_assert import time_out_assert
from tests.wallet_tools import WalletTool
from goji.wallet.derive_keys import (
    ...
    async def setup_keys(self):
        if self.local_keychain:
            ...
            self.keychain_proxy = await connect_to_keychain_and_validate(
                self.root_path, log, user="testing-1.8.0", service="goji-testing-1.8.0"
            )
        ...
        if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
            raise RuntimeError("Keys not generated. Run `goji generate keys`")
    ...
    async def new_plot(
        ...
        try:
            ...
            if pool_contract_puzzle_hash is None:
                ...
                pool_address = encode_puzzle_hash(pool_contract_puzzle_hash, "xgj")
